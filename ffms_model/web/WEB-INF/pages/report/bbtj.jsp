        ...
        <tr valign="top">
          ...
          <td align="right"><img src="${pageContext.request.contextPath}/images/icon01.gif" width="35" height="21" align="absmiddle"><span class="text010">报表类型
            <select name="select1" class="inp004" onChange="selectBb()">
              <option selected  value="toReportBbtj_01">收支汇总报表</option>
              <option value="toReportBbtj_02">年度收支统计表</option>
              <option value="bbtj_03.html">收入构成图表</option>
              <option value="bbtj_04.html">支出构成图表</option>
              <option value="bbtj_05.html">家庭成员收支表</option>
            </select>
          </span>		  </td>
        </tr>
      </table></td>
  ...
  <tr>
    <td height="215" valign="top"><table width="98%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="98%" border="0" cellpadding="0" cellspacing="0" class="bor003">
        <tr>
          <td height="40" align="left" valign="top" ><iframe name="exlframe" src="toReportBbtj_01" width="100%" height="400px" frameborder="0" align="top"></iframe>         </td>
        </tr>
      </table></td>
  </tr>
</table>
