    ...
    <td height="215" valign="top"><table width="98%"  border="0" cellspacing="0" cellpadding="0">
      <tr align="center" class="bg03">
        <td width="13%" height="29">
          <input type="checkbox" name="itemCListChk" value="checkbox">
      ...
      <c:forEach items="${items.items}" var="item" varStatus="index">
        <c:if test="${item.pItem==null}">
            <c:choose>
                ...
                <td height="35"><input type="checkbox" name="itemCListCheck" value="checkbox" id="${item.id}"></td>
                <c:choose>
            ...
            <td align="center"><a href="toCItemDetail?id=${item.id}">${item.name}</a></td>
                <input type="hidden" value="${item.id}" id="deleteItemId">
                <input type="hidden" value="${items.id}" id="deleteItemPId">
                <td><a href="toCItemDetail?id=${item.id}"><img src="${pageContext.request.contextPath}/images/icon_resault.gif" alt="查 看" width="12" height="15" hspace="10" border="0"></a><a href="toCItemEdit?id=${item.id}"><img src="${pageContext.request.contextPath}/images/icon_set.gif" alt="编 辑" width="14" height="15" border="0"></a><a onclick="return window.confirm('这条记录将被删除且不可恢复，确认删除吗？')" href="javascript:deleteItem()"><img src="${pageContext.request.contextPath}/images/delete.gif" alt="删 除" width="13" height="16" hspace="10"></a></td>
            </tr>
        </c:if>
      </c:forEach>
    </table>
