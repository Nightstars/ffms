      ...
      <table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text008">
        <tr align="center">
          ...
          <td width="88%" align="left"><span class="text010">
            <select name="select" class="inp005" id="itemAddType">
        ...
        <tr align="center" class="bg04">
          ...
          <td align="left">
          	<select name="select" class="inp005" id="itemAddPItem">
              <option selected value="0">父项目</option>
